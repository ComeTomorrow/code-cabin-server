...
public class GlobalExceptionHandler {
    ...
    public <T> Result<T> processException(NoHandlerFoundException e) {
        ...
        return Result.failed(ResultCode.RESOURCE_NOT_FOUND,null);
    }
    ...
    public <T> Result<T> processException(MissingServletRequestParameterException e) {
        log.error(e.getMessage(), e);
        return Result.failed(ResultCode.PARAM_IS_NULL,null);
    }
    ...
    public <T> Result<T> processSQLSyntaxErrorException(SQLSyntaxErrorException e) {
        ...
        if (StrUtil.isNotBlank(errorMsg) && errorMsg.contains("denied to user")) {
            return Result.failed(ResultCode.FORBIDDEN_OPERATION,null);
        } else {
            return Result.failed(e.getMessage());
        }
    }
    ...
    public <T> Result<T> handleBizException(BizException e) {
        ...
        if (e.getResultCode() != null) {
            return Result.failed(e.getResultCode(),null);
        }
        return Result.failed(e.getMessage());
    }
